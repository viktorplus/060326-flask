...
- `l05_orm_relationships/app.py:128` *(в закомментированном учебном блоке)* — `#     session.add(user)`
- `l05_orm_relationships/app.py:136` *(в закомментированном учебном блоке)* — `#     session.add_all(users)`
