...
- `p02_pydantic_classwork/app.py:45` — `user = User.model_validate_json(json_string, strict=False)`
- `p02_pydantic_classwork/models.py:107` — `user = User.model_validate_json(json_string, strict=False)`
